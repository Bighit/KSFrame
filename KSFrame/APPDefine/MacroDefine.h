...
#define mSystemVersion   ([[[UIDevice currentDevice] systemVersion] intValue])
...
#ifndef debug
#define NSLog(fmt, ...) NSLog((@"[Function:%s][Line:%d]\n^^^^^^^^^^^^^^^^^^^\n " fmt @"\n_____________________"),__PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)
