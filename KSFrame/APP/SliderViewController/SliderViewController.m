...
- (void)viewDidLoad
{
    ...
    [self showContentControllerWithModel:@"GasStationListViewController"];
...
- (void)showContentController:(UIViewController *)viewController
{
    ...
    if (self.MainVC == nil) {
        viewController.view.frame = _mainContentView.bounds;
        ...
        [_mainContentView addSubview:self.MainVC.view];
        [self.MainVC didMoveToParentViewController:self];
    } else if (self.MainVC != viewController && viewController !=nil) {
        viewController.view.frame = _mainContentView.bounds;
        [self.MainVC willMoveToParentViewController:nil];
        [self addChildViewController:viewController];
        self.view.userInteractionEnabled = NO;
        [self transitionFromViewController:self.MainVC
                          toViewController:viewController
                                ...
                                completion:^(BOOL finished){
                                    ...
                                    _currentMainController = viewController;
    ...
    if (!controller)
    {
        ...
        controller = [[[c alloc] init] autorelease];
#endif
        [_controllersDict setObject:controller forKey:NSStringFromClass(c)];
    }
